...
exports.defaultSecurityConfig = exports.createSecurityMiddleware = exports.SecurityMiddleware = void 0;
...
class SecurityMiddleware {
    ...
    isOriginAllowed(origin) {
        if (!origin)
            return true; // Allow requests without origin (non-browser)
...
const createSecurityMiddleware = (config) => new SecurityMiddleware(config);
